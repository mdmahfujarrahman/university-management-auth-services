...
const getSingleDepartment = (DepartmentId) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllDepartments = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andCondition.push({
            $or: academicDepartment_constant_1.academicDepertmentSearchableFields.map(field => ({
                [field]: {
                    $regex: searchTerm,
                    $options: 'i',
                },
...
const updateDepartment = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedDepartment = yield academicDepartment_model_1.AcademicDepartment.findOneAndUpdate({ _id: id }, payload, { new: true }).populate('academicFaculty');
    return updatedDepartment;
});
const deleteDepartment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deleteDepartment = yield academicDepartment_model_1.AcademicDepartment.findByIdAndDelete(id);
