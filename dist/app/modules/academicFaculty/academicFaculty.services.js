...
const updateFaculty = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedFaculty = yield academicFaculty_model_1.AcademicFaculty.findOneAndUpdate({ _id: id }, payload, { new: true });
    return updatedFaculty;
});
const deleteFaculty = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deleteFaculty = yield academicFaculty_model_1.AcademicFaculty.findByIdAndDelete(id);
